...
class WeatherWarning(Base):
    ...
    valid_time_start = Column(String, nullable=True) # 特報實際生效開始時間
    valid_time_end = Column(String, nullable=True) # 特報實際生效結束時間
    update_time = Column(String, nullable=True) # API update 時間
